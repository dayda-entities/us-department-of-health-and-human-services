...
modified: '2021-05-15T11:11:40.812914'
state: active
type: dataset
tags:
  - '2021'
  ...
  - Wonder
groups: []
csv_url: 'https://data.cdc.gov/api/views/snev-n7vb/rows.csv?accessType=DOWNLOAD'
json_url: 'https://data.cdc.gov/api/views/snev-n7vb/rows.json?accessType=DOWNLOAD'
layout: post

---
NNDSS - TABLE 1OO. Viral hemorrhagic fevers, Machupo virus to Viral hemorrhagic fevers, Sabia virus – 2021. In this Table, provisional cases* of notifiable diseases are displayed for United States, U.S. territories, and Non-U.S. residents.
